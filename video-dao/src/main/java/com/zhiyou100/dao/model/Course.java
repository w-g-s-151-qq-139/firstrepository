...
public class Course {
	...
	public String toString() {
		return "Course [id=" + id + ", courseName=" + courseName + ", subjectName=" + subjectName + ", courseDescr="
				+ courseDescr + ", insertTime=" + insertTime + ", updateTime=" + updateTime + ", subjectId=" + subjectId
				+ "]";
	}
